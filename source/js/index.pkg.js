...
},{"backbone":6,"jquery":10,"underscore":11}],2:[function(require,module,exports){
...
},{"../utilities":26,"./collections/genders":13,"./collections/locale_gender_results":14,"./collections/locales":15,"./routes":19,"./views/genders":20,"./views/graph":21,"./views/layout":22,"./views/locales":23,"backbone":6,"backbone.marionette":2}],13:[function(require,module,exports){
'use strict';
...
},{"../models/gender":16,"backbone":6}],14:[function(require,module,exports){
'use strict';
...
},{"../models/result":18,"backbone":6,"jquery":10}],15:[function(require,module,exports){
'use strict';
...
},{"../../utilities":26,"../models/locale":17,"backbone":6,"jquery":10}],16:[function(require,module,exports){
'use strict';
...
},{"../visuals/grid_map":24,"backbone":6}],22:[function(require,module,exports){
'use strict';
...
},{"backbone.marionette":2,"jquery":10}],24:[function(require,module,exports){
'use strict';
  ...
  _createClass(GridMap, [{
    ...
    value: function drawColumnTitles(selection) {
      ...
      columns.text(function (d) {
        ...
        var transform = 'translate(' + (_this.x_scale(d) + _this.x_scale.rangeBand() / 2) + ', 0)';
    ...
    value: function drawRows(selection) {
      ...
      selection.attr('transform', function (d, i) {
        return 'translate(100, ' + i * _this3.block_height + ')';
      });
    ...
    value: function drawCells(selection) {
      ...
      selection.selectAll('title').text(function (d) {
...
},{"../../utilities":26,"d3":9,"underscore":11}],25:[function(require,module,exports){
'use strict';
...
},{"./app/application":12,"backbone":6,"backbone-fetch-cache":1,"bootstrap/js/dropdown":8,"jquery":10}],26:[function(require,module,exports){
"use strict";
