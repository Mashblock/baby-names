...
},{"backbone":6,"jquery":12,"underscore":13}],2:[function(require,module,exports){
...
App.on('start', function () {
  ...
  this.results.on('request', function () {
    return _this.toggleLoading(true);
  });
  this.results.on('sync', function () {
...
App.on('start', function () {
  ...
  this.layout.getRegion('genders').show(new GenderView({ collection: this.genders }));
  this.layout.getRegion('locales').show(new LocaleView({ collection: this.locales }));
  this.layout.getRegion('graph').show(new GraphView({ collection: this.results }));
});
...
},{"../utilities":28,"./collections/genders":15,"./collections/locale_gender_results":16,"./collections/locales":17,"./routes":21,"./views/genders":22,"./views/graph":23,"./views/layout":24,"./views/locales":25,"backbone":6,"backbone.marionette":2}],15:[function(require,module,exports){
'use strict';
...
},{"../models/gender":18,"backbone":6}],16:[function(require,module,exports){
'use strict';
...
},{"../models/result":20,"backbone":6,"jquery":12}],17:[function(require,module,exports){
'use strict';
...
var Locales = Backbone.Collection.extend({
  ...
  selectFromIPAddress: function selectFromIPAddress() {
    var _this = this;
...
},{"../../utilities":28,"../models/locale":19,"backbone":6,"jquery":12}],18:[function(require,module,exports){
'use strict';
...
},{"../visuals/grid_map":26,"backbone":6}],24:[function(require,module,exports){
'use strict';
...
},{"backbone.marionette":2,"jquery":12}],26:[function(require,module,exports){
'use strict';
...
var GridMap = (function () {
  function GridMap(element, collection) {
    ...
    this.year_titles = this.svg.append('g').attr('class', 'year-title').attr('transform', 'translate(100,' + (this.top_margin - 5) + ')');
  ...
  _createClass(GridMap, [{
    ...
    value: function render() {
      ...
      this.current_years = _.unique(this.collection.pluck('year')).sort(function (a, b) {
        return a - b;
      });
      ...
      this.current_years.forEach(function (y) {
        var values = this.collection.where({ year: y }).map(function (d) {
          return d.get('number');
        });

        this.shades[y] = d3.scale.linear().range(['#fff', this.color]).domain(d3.extent(values));
      }, this);

      var grouped_data = d3.nest().key(function (d) {
        return d.get('name');
      }).sortKeys(d3.ascending).entries(this.collection.models);

      this.svg.attr('height', grouped_data.length * this.block_height + this.top_margin);

      this.paper.selectAll('g.rows').data(grouped_data, function (d) {
        return d.key;
    ...
    value: function reposition() {
      ...
      this.paper.selectAll('text.right-text').style('visibility', this.media == 'xs' ? 'hidden' : 'visible').attr('transform', 'translate(' + (this.width - 180) + ',0)');

      var cells = this.paper.selectAll('g.cell').attr('transform', function (d) {
        return 'translate(' + _this2.x_scale(d.get('year')) + ', 0)';
      });
      cells.selectAll('text.rank_status').attr('x', this.x_scale.rangeBand() / 2);
      cells.selectAll('rect').attr('width', this.x_scale.rangeBand());
    }
  }, {
    key: 'reorder',
    value: function reorder() {
      ...
      if (this.order_year) {
        this.current_names = this.collection.chain().filter(function (d) {
          return d.get('year') == _this3.order_year;
        }).sortBy(function (d) {
          return d.get('rank');
        }).map(function (d) {
          return d.get('name');
      ...
      this.paper.selectAll('g.rows').sort(function (a, b) {
        if (a.key > b.key) return 1;
        if (a.key < b.key) return -1;
        return 0;
      }).attr('transform', bind(this.rowPosition, this));

      this.year_titles.selectAll('text').style('font-weight', function (d) {
        if (d == _this.order_year) return 'bold';
      });
    }
  }, {
    key: 'drawColumnTitles',
    value: function drawColumnTitles(selection) {
      var _this = this;
      var columns = selection.selectAll('text').data(this.current_years);

      columns.enter().append('text');
      columns.exit().remove();
      columns.text(function (d) {
        return d;
      }).attr('transform', bind(this.titlePosition, this)).on('click', bind(this.selectColumn, this));
    }
  }, {
    key: 'drawRows',
    value: function drawRows(selection) {
      var new_row = selection.enter().append('g').attr('class', 'rows');

      new_row.append('text').attr('class', 'left-text').attr('transform', 'translate(-10, 0)');

      new_row.append('text').attr('class', 'right-text');

      selection.exit().remove();

      selection.selectAll('text').style('fill', this.color).attr('y', this.block_height / 2).text(function (d) {
        return d.key;
      });

      selection.selectAll('g.cell').data(function (d) {
        return d.values;
      }, function (d) {
        return d.id;
    ...
    key: 'drawCells',
    value: function drawCells(selection) {
      var _this = this;
      var new_cells = selection.enter().append('g').attr('class', 'cell');
      ...
      selection.attr('data-toggle', 'popover').attr('data-trigger', 'hover').attr('data-container', 'body').attr('data-placement', 'top').attr('data-html', 'true').attr('data-title', function (d) {
        return '' + d.get('name') + ' - ' + d.get('year');
      }).attr('data-content', function (d) {
        return template(d.attributes);
      });

      selection.selectAll('text.rank_status').text(function (d) {
        return d.get('rank') == 1 ? '★' : '';
      }).attr('y', this.block_height / 2);

      selection.selectAll('rect').attr('height', this.block_height).style('fill', function (d) {
    ...
    key: 'titlePosition',
    value: function titlePosition(d) {
      var transform = 'translate(' + (this.x_scale(d) + this.x_scale.rangeBand() / 2) + ', 0)';
      if (this.media == 'xs') transform += 'rotate(90)';
      return transform;
    }
  }, {
    key: 'rowPosition',
    value: function rowPosition(d, i) {
...
},{"../../utilities":28,"d3":11,"underscore":13}],27:[function(require,module,exports){
'use strict';
...
},{"./app/application":14,"backbone":6,"backbone-fetch-cache":1,"bootstrap/js/dropdown":8,"bootstrap/js/popover":9,"bootstrap/js/tooltip":10,"jquery":12}],28:[function(require,module,exports){
"use strict";
